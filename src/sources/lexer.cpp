...
TagStrMap	Mer::TagStr{
	{ IMPORT,"IMPORT" },{ NAMESPACE,"NAMESPACE" },{ CLASS,"class" },{NEW,"new"},{ARROW,"ARROW"},
	{ REF,"REF" },{ ENTRY,"PROGRAME" },{ COMMA,"COMMA" },{ COLON,"COLON" },{QUE,"QUE"},
	...
	{ SEMI,"SEMI" },{ ASSIGN,"ASSIGN" },{ SADD,"SADD" },{ SXOR,"SXOR" },{ SAND,"SAND" },{ SOR,"SOR" },
	{ CASE,"CASE" },
...
TokenMap	Mer::BasicToken{
	...
	{ "using",new Token(IMPORT) },{ "namespace",new Token(NAMESPACE) },{ "class",new Token(CLASS) },
	...
	{ "fn",new Token(FUNCTION) },{ "return",new Token(RETURN) },
	...
	{ "int",new Token(INTEGER_DECL) },{"const",new Token(CONST_DECL)}, { "entry",new Token(ENTRY) },{"null",new Token(NULLPTR)},
